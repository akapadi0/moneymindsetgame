      ...
      <div className={`transition-all duration-500 ${!isUnlocked ? 'filter blur-sm opacity-60 pointer-events-none' : ''}`}>
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            <img src={wealthIqLogo} alt="Wealth IQ - Conscious Prosperity" className="h-20 mix-blend-multiply mx-auto mb-6" data-testid="img-logo-results" />
            ...
            <div className="flex flex-wrap gap-3 justify-center mb-6">
              <Button 
                ...
                onClick={() => {
                  ...
                  const text = xPosts[xComboKey] || "Took the Wealth IQ assessment — it reveals your money personality based on how you actually think about money.\n\nThe blind spots were the real surprise.\n\nWhat's yours?";

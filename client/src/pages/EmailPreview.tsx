                ...
                <tbody>
                  <tr>
                    ...
                    <td style={{ textAlign: 'center', paddingLeft: '6px', width: '50%' }}>
                      <a
                        href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://wealthiq.app')}&title=${encodeURIComponent('WealthIQ Money Mindset Assessment')}&summary=${encodeURIComponent(`Turns out when it comes to money, I'm ${({Strategists:"a long-term planner who thrives on structure",Guardians:"security-first with a focus on protecting what I have",Givers:"driven by generosity and helping others",Adventurers:"a risk-taker who chases new opportunities",Impressors:"motivated by quality and how success looks","Free Spirits":"someone who follows their instincts over spreadsheets"} as Record<string,string>)[primary[0]] || ""} — but also ${({Strategists:"a long-term planner who thrives on structure",Guardians:"security-first with a focus on protecting what I have",Givers:"driven by generosity and helping others",Adventurers:"a risk-taker who chases new opportunities",Impressors:"motivated by quality and how success looks","Free Spirits":"someone who follows their instincts over spreadsheets"} as Record<string,string>)[secondary[0]] || ""}.\n\nWe all have a money personality. Patterns that shape how we earn, spend, save, and invest without us even realizing it.\n\nWhat surprised me most? The blind spots.\n\nWhat's yours? 👇`)}`}

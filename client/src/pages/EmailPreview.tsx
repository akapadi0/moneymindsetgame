                ...
                <tbody>
                  <tr>
                    ...
                    <td style={{ textAlign: 'center', paddingLeft: '6px', width: '50%' }}>
                      <a
                        href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://wealthiq.app')}&title=${encodeURIComponent('WealthIQ Money Mindset Assessment')}&summary=${encodeURIComponent(`Turns out I'm a ${primary[0]}-${secondary[0]} when it comes to money.\n\nWe all have a money personality — patterns that shape how we earn, spend, save, and invest without us even realizing it.\n\nWhat surprised me most? The blind spots.\n\nWhat's yours? 👇`)}`}
